...
fig.update_xaxes(nticks=9, type='date', tickformat='%H:%M', title_text="Tempo real")
fig.update_yaxes(title_text="Pacotes por segundo (PPS)")
...
#
#
# fig2.update_xaxes(nticks=9, type='date', tickformat='%H:%M', title_text="Tempo real")
# fig2.update_yaxes(title_text="Q. de Classificações")
# fig2.update_layout(width=840, height=420, legend=dict(orientation="h"))
